...
- **Stav:** živý / mrtvý.
- **Respawn cooldown:** 30 kroků po smrti.
...
### Mutanti — Šíření slizu (Slime)
- Když Mutant stojí na vlastním prázdném hexu, automaticky ho pokryje slizem (`TileType.Slime`).
- Navíc sliz se **šíří na sousední neutrální hexy** s 20% pravděpodobností za krok.
- Sliz pokrytý hex se automaticky stane vlastnictvím Mutantů.
...
- Boj nastává, když se dvě nepřátelské jednotky ocitnou na **stejném hexu**.
- Oboustranný simultánní damage:
  - Každá jednotka obdrží 1 damage.
  - Výjimka: jednotka se **štítem** (Robot na vlastním území) neobdrží damage.
- Jednotka s 0 HP po boji zemře (→ respawn cooldown).
- Boj se řeší pro všechny kolize v jednom kroku.
...
| Sim Speed | 0.1-20 | 1 | Rychlost simulace (Time.timeScale) |
...
Všechny akce ovládané z Unity editoru přes dokovatelné okno **Project Tools**:
...
### Game
- **Step 1x / 10x / 100x** — ruční krokování s náhodným pohybem.
- **Autoplay** — automatické krokování s nastavitelným intervalem.
...
### Testing
- **Run EditMode Tests Now** — spustí testy okamžitě.
